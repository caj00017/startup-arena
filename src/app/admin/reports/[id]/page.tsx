  ...
  return (
    <section>
      ...
      <p className="mt-6 text-xs font-bold leading-relaxed text-[var(--muted)]">
        Visitor-based rates use anonymous first-party identifiers. A verified vote remains the database vote whose current fraud status is valid; changing moderation status changes this report without rewriting raw events.
      </p>
    </section>
  );
}
