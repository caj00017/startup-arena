  ...
  return (
    <div className="mx-auto max-w-4xl px-5 py-14 sm:py-20">
      ...
      <div className="mt-12 space-y-9 border-t-2 border-[var(--foreground)] pt-9 leading-relaxed">
        ...
        <section><h2 className="text-2xl font-black">Crown-time leaderboard</h2><p className="mt-3 text-[var(--muted)]">Every startup with a finalized win enters the <Link href="/leaderboard" className="font-black text-[var(--foreground)] underline">leaderboard</Link>. Crown time begins when a winner returns in the next matchup as defending champion. Cancelled matchups and downtime before a successor battle do not count.</p></section>
