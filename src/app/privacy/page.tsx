...
export default function PrivacyPage() {
  return (
    <article className="mx-auto max-w-3xl px-5 py-14 leading-relaxed sm:py-20">
      ...
      <p className="mt-5 text-[var(--muted)]">Last updated August 21, 2026. This operational draft should be reviewed by counsel before a public commercial launch.</p>
      <div className="mt-10 space-y-8 text-[var(--muted)]">
        <Section title="Information collected">We store the email address used to verify an account; startup information submitted by founders; bids, payment-provider references, votes, and moderation status; and product analytics such as battle impressions and outbound clicks. We hash IP addresses and user-agent information for abuse prevention rather than storing raw values in the voting record.</Section>
